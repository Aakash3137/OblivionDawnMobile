...
Shader "GPUInstancer/Toony Colors Pro 2/Custom/TCP2SpecularOutlineRim2"
{
	Properties
	{
...
#pragma multi_compile_instancing
		...
		#pragma shader_feature_local _ _ALPHAPREMULTIPLY_ON
			...
			Varyings Vertex(Attributes input)
			{
				...
				UNITY_SETUP_INSTANCE_ID(input);
				GPUI_CROWD_VERTEX(input);
				UNITY_TRANSFER_INSTANCE_ID(input, output);
				UNITY_INITIALIZE_VERTEX_OUTPUT_STEREO(output);

				// Texture Coordinates
				output.pack0.xy.xy = input.texcoord.xy * _BaseMap_ST.xy + _BaseMap_ST.zw;
				// Shader Properties Sampling
...
#pragma multi_compile_instancing
		...
		HLSLINCLUDE
			...
			Varyings ShadowDepthPassVertex(Attributes input)
			{
				...
				// Texture Coordinates
				output.pack1.xy.xy = input.texcoord.xy * _BaseMap_ST.xy + _BaseMap_ST.zw;
