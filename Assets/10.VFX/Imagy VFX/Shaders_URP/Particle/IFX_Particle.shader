...
Shader "QFX/URP/Particle/Alpha Blended Soft Tex"
{
    Properties
    {
        _TexSoftFactor("Tex Soft Factor", Range(0,3)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // Sample texture and apply POW
                half4 tex = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv);
                tex = pow(tex, half4(_TexSoftFactor, _TexSoftFactor, _TexSoftFactor, _TexSoftFactor));

                // Multiply by tint and vertex color
                half4 finalColor = tex * _TintColor * IN.color;
                return finalColor;
            }
            ENDHLSL
        }
