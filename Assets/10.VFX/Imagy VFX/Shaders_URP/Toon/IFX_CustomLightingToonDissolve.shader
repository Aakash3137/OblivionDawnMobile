...
// Shader "QFX/IFX/Toon/CustomLightingToonDissolve"
// {
// 	Properties
// 	{
...
// 			c.rgb = ( ( ( tex2D( _Diffuse, uv_Diffuse ) * tex2D( _ToonRamp, temp_cast_2 ) ) * ( ase_lightColor * float4( ( indirectDiffuse11 + ase_lightAtten ) , 0.0 ) ) ) + ( saturate( ( ( ase_lightAtten * dotResult3 ) * pow( ( 1.0 - saturate( ( dotResult38 + _RimOffset ) ) ) , _RimPower ) ) ) * ( _RimColor * ase_lightColor ) ) ).rgb;
// 			c.a = 1;
...
// /*ASEBEGIN
// Version=16100
// 129;210;1084;799;-306.3158;-156.3884;2.156359;True;False
...
// Node;AmplifyShaderEditor.RangedFloatNode;24;-1264,1040;Float;False;Property;_RimOffset;Rim Offset;8;0;Create;True;0;0;False;0;0.24;0.5;0;0;0;1;FLOAT;0
...
// Node;AmplifyShaderEditor.RangedFloatNode;28;-832,1056;Float;False;Property;_RimPower;Rim Power;7;0;Create;True;0;0;False;0;0.5;1;0;10;0;1;FLOAT;0
...
// Node;AmplifyShaderEditor.RangedFloatNode;68;702.2999,1051.648;Float;False;Property;_DissolveAmount;Dissolve Amount;13;0;Create;True;0;0;False;0;0.37;0.483;0;1;0;1;FLOAT;0
...
// Node;AmplifyShaderEditor.ColorNode;34;-368,1040;Float;False;Property;_RimColor;Rim Color;6;1;[HDR];Create;True;0;0;False;0;0,1,0.8758622,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
// Node;AmplifyShaderEditor.SamplerNode;43;-224,-304;Float;True;Property;_Diffuse;Diffuse;9;0;Create;True;0;0;False;0;84508b93f15f2b64386ec07486afc7a3;d2ec9dd16277c8b4ea31297d725af950;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
// Node;AmplifyShaderEditor.SamplerNode;54;695.8085,-161.1284;Float;True;Property;_EmissionMap;Emission Map;11;0;Create;True;0;0;False;0;None;5b23a5cfe3b97c249a1373b10b4c073e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
// Node;AmplifyShaderEditor.RangedFloatNode;57;794.3105,81.23788;Float;False;Property;_EmissionAdjust;Emission Adjust;12;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
// Node;AmplifyShaderEditor.ColorNode;53;711.9908,-382.2817;Float;False;Property;_EmissionColor;Emission Color;10;1;[HDR];Create;True;0;0;False;0;0,0,0,0;2,1.531035,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
// Node;AmplifyShaderEditor.FunctionNode;61;863.4659,199.6805;Float;False;QFX Get Fresnel;3;;1;0a832704e6daa5244b3db55d16dfb317;0;0;1;FLOAT;0
// Node;AmplifyShaderEditor.RangedFloatNode;80;1719.959,984.323;Float;False;Property;_VertexOffset;Vertex Offset;14;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
// Node;AmplifyShaderEditor.SamplerNode;72;842.3738,834.8264;Float;True;Property;_NoiseMap;Noise Map;16;0;Create;True;0;0;False;0;None;140c5b15ccac91a4fb58b5ea4666c02f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
// Node;AmplifyShaderEditor.RangedFloatNode;74;1249.683,222.7852;Float;False;Property;_DissolveEdgeWidth;Dissolve Edge Width;15;0;Create;True;0;0;False;0;0.37;0.52;0;1;0;1;FLOAT;0
...
// Node;AmplifyShaderEditor.ColorNode;76;1258.244,320.7299;Float;False;Property;_DissolveColor;Dissolve Color;2;1;[HDR];Create;True;0;0;False;0;1,1,1,1;2,0.3724137,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
// Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2134.129,419.7604;Float;False;True;2;Float;ASEMaterialInspector;0;0;CustomLighting;QFX/IFX/Toon/CustomLightingToonDissolve;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;TransparentCutout;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0.02;1,1,1,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
// ASEEND*/
// //CHKSM=2882AB86CB64583225654500E9EB5BD890172097

Shader "QFX/IFX/Toon/CustomLightingToonDissolve_URP"
{
    Properties
    {
        _Cutoff("Mask Clip Value", Float) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                float dissolveProgress = 1.0 - (_DissolveAmount + input.uv1.z);
                float remappedDissolve = lerp(-0.6, 0.6, dissolveProgress);
                float dissolveFactor = noiseValue + remappedDissolve;
                
                // Alpha clip for dissolve
                clip(dissolveFactor - _Cutoff);
                ...
                // Toon ramp lighting
                float2 toonUV = float2(NdotL * 0.5 + 0.5, 0.5);
                float4 toonColor = SAMPLE_TEXTURE2D(_ToonRamp, sampler_ToonRamp, toonUV);
                
                // Diffuse texture
                float2 diffuseUV = TRANSFORM_TEX(input.uv, _Diffuse);
                float4 diffuseTex = SAMPLE_TEXTURE2D(_Diffuse, sampler_Diffuse, diffuseUV);
                
                // Base lighting
                float3 lighting = diffuseTex.rgb * toonColor.rgb * mainLight.color * mainLight.distanceAttenuation * mainLight.shadowAttenuation;
                
                // Rim lighting
                float3 viewDir = normalize(_WorldSpaceCameraPos.xyz - input.positionWS);
                float VdotN = dot(viewDir, normalWS);
                float rim = 1.0 - saturate(VdotN + _RimOffset);
                rim = pow(rim, _RimPower);
                rim *= mainLight.distanceAttenuation * mainLight.shadowAttenuation;
                float3 rimLighting = rim * _RimColor.rgb * mainLight.color;
                
                // Combine lighting
                float3 finalColor = lighting + rimLighting;
                
                // Fresnel emission
                float fresnel = saturate(_FresnelScale * pow(1.0 - saturate(dot(normalWS, viewDir)), _FresnelPower));
                
                // Emission
                float2 emissionUV = TRANSFORM_TEX(input.uv, _EmissionMap);
                float4 emissionTex = SAMPLE_TEXTURE2D(_EmissionMap, sampler_EmissionMap, emissionUV);
                emissionTex = pow(emissionTex, _EmissionAdjust);
                float3 emission = _EmissionColor.rgb * emissionTex.rgb * fresnel;
                
                // Dissolve edge glow
                if (_DissolveEdgeWidth > dissolveFactor)
                {
                    emission = _DissolveColor.rgb;
                }
                else
                {
                    emission = _EmissionColor.rgb * emissionTex.rgb * fresnel;
                }
        ...
        Pass
        {
            ...
            ShadowVaryings ShadowPassVertex(ShadowAttributes input)
            {
                ...
                // Calculate noise for vertex offset (same as in main pass)
                float2 noiseUV = TRANSFORM_TEX(uv, _NoiseMap);
                float noiseValue = SAMPLE_TEXTURE2D_LOD(_NoiseMap, sampler_NoiseMap, noiseUV, 0).r;
            ...
            half4 ShadowPassFragment(ShadowVaryings input) : SV_TARGET
            {
                ...
                // Dissolve effect (same as in main pass)
                float2 noiseUV = TRANSFORM_TEX(input.uv, _NoiseMap);
                float noiseValue = SAMPLE_TEXTURE2D(_NoiseMap, sampler_NoiseMap, noiseUV).r;
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.CustomLightingToonDissolveShaderGUI"
