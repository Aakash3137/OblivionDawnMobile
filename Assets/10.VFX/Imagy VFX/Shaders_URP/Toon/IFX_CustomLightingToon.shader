...
// Shader "QFX/IFX/Toon/CustomLightingToon"
// {
// 	Properties
// 	{
...
// Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1818.513,252.661;Float;False;True;2;Float;ASEMaterialInspector;0;0;CustomLighting;QFX/IFX/Toon/CustomLightingToon;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0.02;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
// ASEEND*/
// //CHKSM=571F72942C59E6EFBFD23B314A2C7BE96E0071C7

Shader "QFX/URP/Toon/CustomLightingToon"
{
    Properties
    {
        _Diffuse("Diffuse", 2D) = "white" {}
        ...
        [HDR]_RimColor("Rim Color", Color) = (0,1,0.875,1)
        _RimPower("Rim Power", Range(0,10)) = 0.5
        _RimOffset("Rim Offset", Float) = 0.24
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings i) : SV_Target
            {
                ...
                // === N.L wrapped (Half Lambert) ===
                float NdotL = dot(normal, lightDir);
                float wrapped = saturate(NdotL * 0.5 + 0.5);

                // === Toon Ramp ===
                float2 rampUV = float2(wrapped, 0.5);
                ...
                float3 diffuse = albedo * ramp * mainLight.color.rgb;

                // === Rim Lighting ===
                float NdotV = dot(normal, i.viewDirWS);
                float rim = pow(1.0 - saturate(NdotV + _RimOffset), _RimPower);
                float3 rimColor = rim * _RimColor.rgb * mainLight.color.rgb;

                // === Fresnel Emission ===
                float fresnel = _FresnelScale * pow(1.0 - saturate(NdotV), _FresnelPower);
                float3 emissionMap = SAMPLE_TEXTURE2D(
                    _EmissionMap,
                    sampler_EmissionMap,
                    TRANSFORM_TEX(i.uv, _EmissionMap)
                ).rgb;

                float3 emission =
                    _EmissionColor.rgb *
                    pow(emissionMap, _EmissionAdjust) *
                    saturate(fresnel);
