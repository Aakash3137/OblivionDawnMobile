...
public class ProjectileMoveScript : MonoBehaviour
{
	...
	void Start()
	{
		...
		{
			var muzzleVFX = Instantiate(muzzlePrefab, transform.position, Quaternion.identity, vfxPool.transform);
	...
	void OnCollisionEnter(Collision co)
	{
		if (!bounce)
		{
			if (co.gameObject.tag != "Bullet" && !collided)
			{
				...
				if (hitPrefab != null)
				{
					var hitVFX = Instantiate(hitPrefab, pos, rot, vfxPool.transform) as GameObject;
