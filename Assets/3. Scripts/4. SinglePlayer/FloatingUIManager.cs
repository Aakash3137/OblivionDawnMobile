...
//         // Spawn new UI at tile position
//         Vector3 spawnPos = tile.transform.position + Vector3.up * 2f; // offset above tile
//         currentUI = Instantiate(floatingUIPrefab, spawnPos, Quaternion.identity);
...
//         if (currentUI != null)
//         {
//             // Make UI face the camera every frame
//             currentUI.transform.LookAt(Camera.main.transform);
//         }
//     }
// }
