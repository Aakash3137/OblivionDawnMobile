...
// {
//     [Header("Production Settings")]
//     public UnitData unitToProduce;
//     public Transform spawnPoint;
//     public bool autoProduce = true;

//     private UnitSide buildingSide;
//     private Transform unitPool;

//     // References to both sides' MainBuildings
//     private BuildingHealth ownMainBuildingHealth;
...
//             BuildingHealth health = b.GetComponent<BuildingHealth>();
//             if (side.side == buildingSide.side)
//                 ownMainBuildingHealth = health;
//             else
//                 enemyMainBuildingHealth = health;
//         }
//     }
...
//         while (true)
//         {
//             bool ownDead = ownMainBuildingHealth != null && ownMainBuildingHealth.currentHealth <= 0;
//             bool enemyDead = enemyMainBuildingHealth != null && enemyMainBuildingHealth.currentHealth <= 0;

//             if (ownDead || enemyDead)
//             {
//                 Debug.Log($"{buildingSide.side} production stopped: A MainBuilding was destroyed.");
//                 yield break;
//             }
...
//         GameObject unit = Instantiate(unitToProduce.prefab, spawnPoint.position, Quaternion.identity);
//         if (unitPool != null) unit.transform.SetParent(unitPool);
