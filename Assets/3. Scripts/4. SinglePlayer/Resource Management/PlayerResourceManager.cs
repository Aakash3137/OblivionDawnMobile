...
public class PlayerResourceManager : MonoBehaviour
{
    ...
    [SerializeField] private BuildingUpgradeCost[] startingResources = new BuildingUpgradeCost[4];
    ...
    [Header(" EDITOR VIEW ONLY ")]    [field: SerializeField]
    ...
    public bool HasResources(BuildingUpgradeCost[] resources)
    {
