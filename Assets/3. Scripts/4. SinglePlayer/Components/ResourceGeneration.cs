...
{
    [SerializeField] private ResourceBuildingDataSO buildingResourceData;
    ...
    private void Awake()
    {
        ...
        ResourceName = buildingResourceData.buildingIdentity.name;

        //Set resource generation values
        resourceAmountPerBatch = buildingResourceData.resourceBuildingUpgradeData[buildingCurrentLevel].resourceAmountPerBatch;
        resourceTimeToProduce = buildingResourceData.resourceBuildingUpgradeData[buildingCurrentLevel].resourceTimeToProduce;
        resourceGenerationRate = buildingResourceData.resourceBuildingUpgradeData[buildingCurrentLevel].resourceGenerationRate;
